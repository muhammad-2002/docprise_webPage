...
export default function Navbar() {
  ...
  return (
    <nav className="fixed z-50 top-0 left-1/2 transform -translate-x-1/2 bg-background-primary w-[95%] md:w-[80%] px-4 py-2 mx-auto mt-5 md:rounded-lg">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          <Link href="/" className="text-gray-700 hover:text-white transition">
            Home
          </Link>
          <Link
            href="/about"
          ...
          <div className="relative">
            <button
              className="text-gray-700 hover:text-white transition flex items-center"
            ...
            {dropdownOpen && (
              <div className="absolute top-8 left-0 bg-white shadow-lg rounded-md z-10">
                <Link
        ...
        <Link
          href="#_"
          className="relative inline-flex items-center justify-center px-2 md:px-6 md:py-3 py-2 overflow-hidden font-bold text-white rounded-md shadow-2xl group"
        >
